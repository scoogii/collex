...
const ReviewModal = ({ reviewOpen, setReviewOpen, getCampaignReviews }) => {
  ////////// STATE VARIABLES //////////
  ...
  const handleSubmitCampaignReview = async () => {
    const response = await fetch(
      `http://localhost:8080/reputation/add_campaign_review?campaign=${router.query.campaign
      }&username=${localStorage.getItem(
        "username",
      )}&message=${reviewMessage}&rating=${rating}`,
      {
        method: "POST",
        headers: {
